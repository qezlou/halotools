...
from ...occupation_models import alam20_components, zheng07_components
from ...phase_space_models import NFWPhaseSpace, TrivialPhaseSpace

from ....sim_manager import sim_defaults
from ....custom_exceptions import HalotoolsError

__all__ = ['alam20_model_dictionary']


def alam20_model_dictionary(
    ...
    behavior is `~halotools.empirical_models.Alam20Cens`.
    ...
    the class governing this behavior is `~halotools.empirical_models.Alam20Sats`;
    ...
    modulate_with_cenocc : bool, optional
        If set to True, the `Alam20Sats.mean_occupation` method will
        ...
        according to `Alam20Cens.mean_occupation`.
    ...
    `~halotools.empirical_models.Alam20Sats` class, this keyword is not permissible
    ...
    centrals_occupation = alam20_components.Alam20Cens(
    ...
    if 'cenocc_model' in list(kwargs.keys()):
        msg = ("Do not pass in the ``cenocc_model`` keyword to ``alam20_model_dictionary``.\n"
            "The model bound to this keyword will be automatically chosen to be Alam20Cens \n")
